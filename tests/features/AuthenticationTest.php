...
{
    function test_a_user_can_login_with_token_url()
    {
        //Having
    ...
    function test_a_user_canot_login_with_invalid_token_url()
    {
        //Having
        $user = $this->defaultUser();
    ...
    function test_a_user_canot_use_the_same_token_twice()
    {
        //Having
        $user = $this->defaultUser();
